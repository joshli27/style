...
with open('tokenizer_occasion_unigram.pickle', 'wb') as handle:
...
#                             batch_size=128)
# model2.save('occasion_lstm_padding250.h5')  
